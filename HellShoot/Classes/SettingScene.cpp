...
bool SettingLayer::init()
{
    ...
    auto lblSound = Label::createWithTTF(HellcUtils::getUTF8Char("lblSound"), "fonts/hanyi.ttf", 36);
    lblSound->setColor(Color3B(14,83,204));
    lblSound->setPosition(menu->getPosition() - Vec2(100, -30));
    addChild(lblSound, 1);
    
    auto lblMusic = Label::createWithTTF(HellcUtils::getUTF8Char("lblMusic"), "fonts/hanyi.ttf", 36);
