...
bool HelpLayer::init()
{
    ...
    //设置“测试”文字.
    auto txtTest = Label::createWithTTF(HellcUtils::getUTF8Char("test"), "fonts/hanyi.ttf", 18);
    ...
    //设置测试下文字 51work6
    auto test = Label::createWithTTF("Hellc", "fonts/hanyi.ttf", 18);
    ...
    //设置“音乐”文字.
    auto txtMusic = Label::createWithTTF(HellcUtils::getUTF8Char("music"), "fonts/hanyi.ttf", 18);
    ...
    //设置 音乐下文字 YunLong
    auto music2 = Label::createWithTTF("Hellc", "fonts/hanyi.ttf", 18);
    ...
    //设置“音效”文字.
    auto txtSound = Label::createWithTTF(HellcUtils::getUTF8Char("sound"), "fonts/hanyi.ttf", 18);
    ...
    //设置 音效下文字 YunLong
    auto sound2 = Label::createWithTTF("Hellc", "fonts/hanyi.ttf", 18);
    ...
    //设置“信息与服务”文字.
    auto txtInfoService = Label::createWithTTF(HellcUtils::getUTF8Char("info_service"), "fonts/hanyi.ttf", 18);
    ...
    //设置 信息与服务 下文字
    auto infoService = Label::createWithTTF("https://github.com/caiwb1990", "fonts/hanyi.ttf", 18);
